...
public class Episodes {
    ...
    private static Season createEpisode(int position) {
        return new Season(String.valueOf(position), "Episode " + position, makeDetails(position));
    }
